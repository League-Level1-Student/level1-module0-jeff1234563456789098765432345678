...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "You are wrong the person was Arnold Schwarzenegger");
		}
...
if(guessTwo.contentEquals("Leonardo DiCaprio")) {
	JOptionPane.showMessageDialog(null, "You are correct!");
	JOptionPane.showMessageDialog(null, score + 1);
}else {
	JOptionPane.showMessageDialog(null, "You are wrong the person was Leonardo DiCaprio");
}
// 6. Otherwise:
// -- Tell them they are wrong and who the person is
